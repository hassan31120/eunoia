...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3 section-text section-text-left anothar-text">
                        <p>If You Suffer From an axity depression</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 m-auto">
                        ...
                        <p class="color-primary">
                            Other mental health application are focusing on general methods to control the anxiety
                            without telling them anything about their disorder and if they have a one or not , we have
                            seen many people having mental health issues. Admittedly, these issues can be found in any
                            age group but the adult age group is the most affected by it. The youth suicide rate has
                            increased at a considerable rate. In most of the cases, the investigation states that the
                            person was going through some mental trauma. The mental health issues can lead the person to
                            far worse conditions than the most dangerous disease does. That is why mental health
                            awareness has become the primary need for the people.
                            In our application we will teach them about their disorder and their levels ,we will give
                            them the tools to conquer the anxiety .
                            We will track them in their healing journey by connect them to the best psychiatrist
                        </p>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="images-gruop w-100">
                            <div class="d-flex flex-column justify-content-between align-items-center w-100 ml-3 mr-3">
                                <img src="{{asset('auth/assets/hansunsplash.jpg')}}" alt="logo" class="image-page rounded-2 mb-3"
                                    width="90%" height="200">
                                <img src="{{asset('auth/assets/hansunsplash.jpg')}}" alt="logo" class="image-page rounded-2"
                                    width="90%" height="200">
                            </div>
                            <!-- <div> -->
                            <img src="{{asset('auth/assets/le-minh.jpg')}}" alt="logo" class="image-three rounded-2" width="90%"
                                height="420">
                            <!-- </div> -->
                        </div>
                    </div>
    ...
    <footer class="footer">
        <h5 class="text-center color-primary mb-4">All Right Reserved</h5>
    </footer>
